...
class NSDAccess(object):
    ...
    def __init__(self, nsd_folder, *args, **kwargs):
        ...
        self.coco_annotation_file = op.join('/home/gmc62/project/Thesis/Data', 'annotations', '{}_{}.json')
    ...
    def read_image_coco_info(self, image_index, info_type='instances', show_annot=False, show_img=False):
        ...
        if len(image_index) == 1:
            ...
            coco_annot = coco.loadAnns(coco_annot_IDs) # [0]['caption']
